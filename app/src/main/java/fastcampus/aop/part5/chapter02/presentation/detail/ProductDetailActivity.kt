...
import fastcampus.aop.part5.chapter02.databinding.ActivityProductDetailBinding
import fastcampus.aop.part5.chapter02.extensions.load
...
internal class ProductDetailActivity : BaseActivity<ProductDetailViewModel, ActivityProductDetailBinding>() {
    ...
    override fun observeData() {
        viewModel.productDetailState.observe(this){
            when(it) {
